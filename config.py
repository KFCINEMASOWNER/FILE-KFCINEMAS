...
PICS = (environ.get('PICS', 'https://envs.sh/fSY.jpg')).split() # Bot Start Picture
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '1981280736').split()]
BOT_USERNAME = environ.get("BOT_USERNAME", "KF_Movies_Files_bot") # without @
...
DB_URI = environ.get("DB_URI", "mongodb+srv://kfcinemas:kfcinemas11@kfcinemas.0as5a.mongodb.net/?retryWrites=true&w=majority&appName=kfcinemas")
DB_NAME = environ.get("DB_NAME", "KFCINEMAS")
...
if 'DYNO' in environ:
    ...
    ON_HEROKU = False
URL = environ.get("URL", "-1002237896833")
